package nl.novi.backend.service.Security.jwt;

import nl.novi.backend.service.UserDetailsServiceImpl;
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(nl.novi.backend.service.Security.jwt.AuthTokenFilter.class);
